...
Without a background, traces are centered on the detected edge center of mass
(the frame-to-frame center-of-mass translation is removed) and the axes are in
...
the detected edge center of mass of the first selected trace frame fixed:
